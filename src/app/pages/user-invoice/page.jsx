                                ...
                                <div className="md:flex justify-between">
                                    <div>
                                        ...
                                        <div className="flex mt-4">
                                            ...
                                            <Link href="https://1.envato.market/Phiaspora-next" target="_blank" className="text-blue-500 dark:text-white font-medium">https://1.envato.market/Phiaspora-next</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 md:mt-0 md:w-56">
                                        ...
                                        <ul className="list-none">
                                            ...
                                            <li className="flex mt-3 ms-0">
                                                ...
                                                <Link href="mailto:contact@example.com" className="text-slate-400">info@Phiaspora.com</Link>
                                            </li>
                                ...
                                <div className="md:flex justify-between">
                                    ...
                                    <div className="mt-4 md:mt-0">
                                        <div className="text-slate-400 text-center md:text-end">
                                            <h6 className="mb-0"><Link href="/page-terms" target="_blank" className="text-blue-500">Terms & Conditions</Link></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
