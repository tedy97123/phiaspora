...
import FaqTwo from "@/app/components/faq-two";
import Footer from "@/app/components/footer";
import Switcher from "@/app/components/switcher";
import ScrollToTop from "@/app/components/scroll-to-top";

import { termsData } from "@/app/data/data";
        ...
        <section className="relative table w-full py-32 lg:py-40 bg-gray-50 dark:bg-slate-800">
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-blue-500"><Link href="">Utility</Link></li>
                    <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><i className="mdi mdi-chevron-right"></i></li>
                    <li className="inline-block uppercase text-[13px] font-bold text-blue-500" aria-current="page">Terms</li>
                </ul>
            </div>
        </section>
                        ...
                        <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                            ...
                            <ul className="list-none text-slate-400 mt-3">
                                {termsData.map((item,index)=>{
                                    return(
                                        <li className="flex mt-2 ms-0" key={index}><i className="mdi mdi-chevron-right text-blue-500 text-lg align-middle me-2"></i>{item}</li>
                                    )
                                })}
                            </ul>
                            ...
                            <div className="mt-6">
                                ...
                                <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-orange-500 border-orange-500 text-blue-500 hover:text-white rounded-md ms-2">Decline</Link>
                            </div>
                        </div>
                    </div>
                </div>
