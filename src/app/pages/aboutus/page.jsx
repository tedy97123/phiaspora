        ...
        <section className="relative table w-full items-center py-36 bg-[url('/images/hero/pages.jpg')] bg-top bg-no-repeat bg-cover">
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-block">
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white/50 hover:text-white"><Link href="/">Phiaspora</Link></li>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                    ...
                    <div className="lg:col-span-7 md:col-span-6 md:order-1 order-2">
                        <h6 className="text-blue-500 font-semibold uppercase text-lg">Founder</h6>
                        ...
                        <ul className="list-none mt-6 space-x-3">
                            <li className="inline"><Link href="https://dribbble.com/shreethemes" target="_blank" className="inline-flex hover:text-blue-500 dark:hover:text-blue-500"><FiDribbble className="size-5 align-middle" title="dribbble"></FiDribbble></Link></li>
                            <li className="inline"><Link href="http://linkedin.com/company/shreethemes" target="_blank" className="inline-flex hover:text-blue-500 dark:hover:text-blue-500"><FiLinkedin className="size-5 align-middle" title="Linkedin"></FiLinkedin></Link></li>
                            <li className="inline"><Link href="https://www.facebook.com/shreethemes" target="_blank" className="inline-flex hover:text-blue-500 dark:hover:text-blue-500"><FiFacebook className="size-5 align-middle" title="facebook"></FiFacebook></Link></li>
                            <li className="inline"><Link href="https://www.instagram.com/shreethemes/" target="_blank" className="inline-flex hover:text-blue-500 dark:hover:text-blue-500"><FiInstagram className="size-5 align-middle" title="instagram"></FiInstagram></Link></li>
                            <li className="inline"><Link href="https://twitter.com/shreethemes" target="_blank" className="inline-flex hover:text-blue-500 dark:hover:text-blue-500"><FiTwitter className="size-5 align-middle" title="twitter"></FiTwitter></Link></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 justify-center text-center mb-4">
                    <h6 className="text-blue-500 font-semibold uppercase text-lg">Our Promise</h6>
                    ...
                    {promiseData.map((item,index)=>{
                        return(
                            <div className="p-6 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 duration-500 rounded-md bg-white dark:bg-slate-900" key={index}>
                                <i className={`text-4xl text-blue-500 ${item.icon}`}></i>

                                <div className="content mt-6">
                                    <Link href="" className="title h5 text-xl font-medium hover:text-blue-500">{item.title}</Link>
                                    <p className="text-slate-400 mt-3">{item.desc}</p>
                                    
                                    <div className="mt-4">
                                        <Link href="" className="text-blue-500">Read More <i className="mdi mdi-arrow-right"></i></Link>
                                    </div>
                                </div>
                            </div>
                        )
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 justify-center text-center mb-4">
                    <h6 className="text-blue-500 font-semibold uppercase text-lg">Our Minds</h6>
                            ...
                            <div className="lg:col-span-3 md:col-span-6" key={index}>
                                <div className="group text-center">
                                    ...
                                    <div className="content mt-3">
                                        <Link href="" className="text-lg font-semibold hover:text-blue-500 duration-500">{item.name}</Link>
