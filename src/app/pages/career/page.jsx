...
import CounterTwo from "@/app/components/counter-two";
        ...
        <section className="relative table w-full py-36 lg:py-44 bg-[url('/images/hero/pages.jpg')] bg-no-repeat bg-center bg-cover">
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center mt-12">
                    <h3 className="text-4xl leading-normal tracking-wider font-semibold text-white">Job Openings</h3>
                </div>
            </div>
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                        ...
                        <div className="grid grid-cols-12 gap-6 items-center">
                            <div className="col-span-6">
                                <div className="grid grid-cols-1 gap-6">
                                    <Image src='/images/ab3.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="shadow rounded-md" alt=""/>
                                    <Image src='/images/ab4.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="shadow rounded-md" alt=""/>
                                </div>
                            </div>

                            <div className="col-span-6">
                                <div className="grid grid-cols-1 gap-6">
                                    <Image src='/images/ab1.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="shadow rounded-md" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-7 md:col-span-6">
                        <div className="lg:ms-5">
                            ...
                            <div className="mt-6">
                                <Link href="" className="text-blue-500">Read More <i className="mdi mdi-chevron-right align-middle"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        {jobData.map((item,index)=>{
                            return(
                                <div className="group md:flex items-center justify-between p-6 rounded-lg shadow hover:shadow-lg dark:shadow-gray-700 duration-500 mt-6" key={index}>
                                    <div>
                                        <Link href="/" className="text-lg font-semibold hover:text-blue-500">{item.name}</Link>
