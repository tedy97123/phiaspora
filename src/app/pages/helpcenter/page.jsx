...
import FaqAbout from "@/app/components/faq-about";
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 mt-8 gap-6">
                    <div className="flex">
                        <FiHelpCircle className="fea icon-ex-md text-blue-500 me-3 size-5 mt-1"></FiHelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold">How our <span className="text-blue-500">Phiaspora</span> work ?</h5>
                    ...
                    <div className="flex">
                        <FiHelpCircle className="fea icon-ex-md text-blue-500 me-3 size-5 mt-1"></FiHelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold"> Is <span className="text-blue-500">Phiaspora</span> safer to use with my account ?</h5>
