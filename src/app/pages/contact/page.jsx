        ...
        <div className="container-fluid relative mt-20">
            <div className="grid grid-cols-1">
             <div className="w-full leading-[0] border-0">
                    <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3152.003997852646!2d-122.41941548468183!3d37.77492996049436!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809df983c293%3A0xd15c5b707632f041!2sSan%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1566305861440!5m2!1sen!2sin"
                    style={{ border: "4" }}
                    title="San Francisco"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-6">
                    <div className="text-center px-6">
                        <div className="relative text-transparent">
                            <div className="size-20 bg-orange-500/5 text-blue-500 rounded-xl text-2xl flex align-middle justify-center items-center mx-auto shadow-sm dark:shadow-gray-800">
                                <FiPhone/>
                            </div>
                        </div>
                        ...
                        <div className="content mt-7">
                            ...
                            <div className="mt-5">
                                <Link href="tel:+152534-468-854" className="text-blue-500 font-medium">+152 534-468-854</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center px-6">
                        ...
                        <div className="content mt-7">
                            ...
                            <div className="mt-5">
                                <Link href="mailto:contact@example.com" className="text-blue-500 font-medium">contact@example.com</Link>
                            </div>
                        </div>
                    </div>
