...
import { newProduct, salesData } from "@/app/data/data";
        ...
        <section className="relative table w-full items-center pt-36 pb-52 bg-orange-600 bg-[url('/images/hero/bg-shape.png')] bg-center bg-no-repeat bg-cover">
            <div className="container relative">
                <div className="grid grid-cols-1 text-center mt-10">
                    ...
                    <div className="mt-6">
                        <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle text-center bg-white text-blue-500 rounded-md">Offer Grab Now</Link>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                return(
                                    <div className="relative overflow-hidden rounded-md text-center shadow-md" key={index}>
                                        <div className="p-6 bg-orange-500">
                                            <span className="bg-white text-blue-500 font-bold px-2.5 py-0.5 rounded-full h-5">{item.tag}</span>
