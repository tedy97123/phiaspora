            ...
            <table cellpadding="0" cellspacing="0" style={{fontFamily: 'DM Sans, sans-serif' , fontSize: '16px', fontWeight: '400', width: '600px', border: 'none', margin: '0 auto', borderRadius: '6px', overflow: 'hidden', backgroundColor: '#fff', boxShadow:' 0 0 3px rgba(60, 72, 88, 0.15)'}}>
                ...
                <thead style={{padding: '16px', display: 'block'}}>
                    <tr style={{display: 'block', border: 'none', textAlign: 'center', fontSize: '24px',letterSpacing: '1px'}}>
                        <th scope="col" style={{margin: 'auto', display: 'block'}}><Link href="/" style={{display:'flex', justifyContent:'center'}}><Image src='/images/logo-dark.png' alt="" width={264} height={164}/></Link></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{padding: '16px 16px 0'}}>
                            <p style={{margin: '0', color: '#94a3b8'}}>If you have any queries please contact us via our customer support <Link href="" style={{color: '#ea580c'}}>contact@Phiaspora.com</Link> </p>
                        </td>
                    </tr>
    
                    <tr>
                        <td style={{padding: '16px'}}>
                            <p style={{margin: '0', fontSize: '18px', fontWeight: '500'}}>Phiaspora <br/> Support Team</p>
                        </td>
                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style={{textAlign: 'center'}}>
                                            <p style={{margin: '4px 0 10px'}}>© {new Date().getFullYear()} Phiaspora. Designed by <Link href="https://shreethemes.in/" target="_blank" style={{textDecoration: 'none', color: '#fff'}}>Shreethemes</Link>.</p>
                                        </td>
                                    </tr>
