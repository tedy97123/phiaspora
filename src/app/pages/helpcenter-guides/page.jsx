...
import { guidenceData } from "@/app/data/data";
                            ...
                            <div className="" key={index}>
                                ...
                                <ul className="list-none mt-4">
                                    {item.features.map((el, index)=>{
                                        return(
                                            <li className="mt-2 ms-0" key={index}><Link href="" className="text-slate-400"><i className="mdi mdi-arrow-right text-blue-500 me-2"></i>{el}</Link></li>
                                        )
                                    })}
                                </ul>
                            </div>
