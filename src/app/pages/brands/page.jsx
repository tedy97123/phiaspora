        ...
        <section className="relative table w-full py-20 lg:py-24 bg-gray-50 dark:bg-slate-800">
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li className="inline-block uppercase text-[13px] font-bold text-blue-500" aria-current="page">Brands</li>
                </ul>
            </div>
        </section>
                            ...
                            <div className="" key={index}>
                                <ul className="list-none space-y-2">
                                    {item.name.map((el,index)=>{
                                        return(
                                            <li key={index} className="ms-0"><Link href="" className="text-slate-400 text-lg"><i className="mdi mdi-shopping-outline text-blue-500 me-2"></i>{el}</Link></li>
                                        )
                                    })}
                                </ul>
                            </div>
