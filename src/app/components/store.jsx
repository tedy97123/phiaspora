            ...
            <div className="container relative">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
                    <div>
                        ...
                        <h5 className="font-semibold text-xl leading-normal my-4">Phiaspora, U.S.A.</h5>
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <div className="">
                                ...
                                <Link href="tel:+152534-468-854" className="tracking-wide text-blue-500">+152 534-468-854</Link>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <div className="">
                                <h5 className="title font-bold mb-0">Phone</h5>
                                <Link href="tel:+152534-468-854" scroll={false} className="tracking-wide text-blue-500">+152 534-468-854</Link>
                            </div>
                        </div>
