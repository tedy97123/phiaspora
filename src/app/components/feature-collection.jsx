                ...
                <div className="lg:col-span-4 md:col-span-6 md:order-1 order-2">
                    <div className="relative overflow-hidden group rounded-md shadow dark:shadow-gray-800">
                        <Link href="" className="">
                            ...
                            <span className="bg-white dark:bg-slate-900 group-hover:text-blue-500 py-2 px-4 rounded-md shadow dark:shadow-gray-800 absolute mx-4 bottom-4 text-lg font-medium">Ladies Wear</span>
                        </Link>
                    </div>
                </div>
                    ...
                    <div className="grid lg:grid-cols-1 md:grid-cols-2 grid-cols-1 gap-6">
                        <div className="relative overflow-hidden group rounded-md shadow dark:shadow-gray-800">
                            <Link href="" className="">
                                ...
                                <span className="bg-white dark:bg-slate-900 group-hover:text-blue-500 py-2 px-4 rounded-md shadow dark:shadow-gray-800 absolute mx-4 bottom-4 text-lg font-medium">Chappal & Shoes</span>
                            </Link>
                        </div>
                        ...
                        <div className="relative overflow-hidden group rounded-md shadow dark:shadow-gray-800">
                            <Link href="" className="">
                                ...
                                <span className="bg-white dark:bg-slate-900 group-hover:text-blue-500 py-2 px-4 rounded-md shadow dark:shadow-gray-800 absolute mx-4 bottom-4 text-lg font-medium">Sunglasses</span>
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 md:col-span-6 lg:order-3 order-2">
                    <div className="relative overflow-hidden group rounded-md shadow dark:shadow-gray-800">
                        <Link href="" className="">
                            ...
                            <span className="bg-white dark:bg-slate-900 group-hover:text-blue-500 py-2 px-4 rounded-md shadow dark:shadow-gray-800 absolute mx-4 bottom-4 text-lg font-medium">Mens Wear</span>
                        </Link>
                    </div>
                </div>
            </div>
