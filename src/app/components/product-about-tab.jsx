            ...
            <div className="lg:col-span-3 md:col-span-5">
                <div className="sticky top-20">
                    <ul className="flex-column p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                        <li className="ms-0">
                            <button className={`px-4 py-2 text-start text-base font-semibold rounded-md w-full hover:text-blue-500 duration-500 ${activeTab === 1 ? 'text-white bg-orange-500 hover:text-white' :''}`} onClick={()=>setActiveTab(1)}>Description</button>
                        </li>
                        <li className="ms-0">
                            <button className={`px-4 py-2 text-start text-base font-semibold rounded-md w-full hover:text-blue-500 duration-500 ${activeTab === 2 ? 'text-white bg-orange-500 hover:text-white' :''}`} onClick={()=>setActiveTab(2)}>Additional Information</button>
                        </li>
                        <li className="ms-0">
                            <button className={`px-4 py-2 text-start text-base font-semibold rounded-md w-full hover:text-blue-500 duration-500 ${activeTab === 3 ? 'text-white bg-orange-500 hover:text-white' :''}`} onClick={()=>setActiveTab(3)}>Review</button>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                return(
                                    <div className="mt-8 first:mt-0" key={index}>
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Link href="" className="text-slate-400 hover:text-blue-500 duration-500 ms-5"><i className="mdi mdi-reply"></i> Reply</Link>
                                        </div>
