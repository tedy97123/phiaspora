            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                ...
                <div className="lg:col-span-7 md:col-span-6">
                    <div className="lg:ms-8">
                        <h6 className="text-blue-500 font-semibold uppercase text-lg">Our Shop</h6>
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            <div className="">
                                ...
                                <Link href="#" scroll={false} onClick={()=>setModal(true)} className="text-blue-500" >View on Google map</Link>
                            </div>
                        </div>
                    </div>
                </div>
