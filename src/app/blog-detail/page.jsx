                    ...
                    <div className="lg:col-span-4 md:col-span-6">
                        <div className="sticky top-20">
                            ...
                            <div className="text-center mt-8">
                                ...
                                <Link href="" className="text-lg font-medium hover:text-blue-500 transition-all duration-500 ease-in-out h5">Cristina Romsey</Link>
                        ...
                        return(
                            <div className="group relative overflow-hidden" key={index}>
                                ...
                                <div className="mt-6">
                                    ...
                                    <Link href="/blog-detail" className="title text-lg font-semibold hover:text-blue-500 duration-500 ease-in-out">{item.title}</Link>
                                    <p className="text-slate-400 mt-2">{item.desc}</p>

                                    <div className="mt-3">
                                        <span className="text-slate-400">by <Link href="" className="text-slate-900 dark:text-white hover:text-blue-500 dark:hover:text-blue-500 font-medium">Phiaspora</Link></span>
                                    </div>
                                </div>
                            </div>
                        )
