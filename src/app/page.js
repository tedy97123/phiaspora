      ...
      <div className="container relative">
        <div className="grid grid-cols-1 justify-center">
            <div className="text-center">
                <span className="uppercase font-semibold text-lg">San Fransisco</span>
                <h4 className="md:text-6xl text-4xl md:leading-normal leading-normal font-bold my-3">Phiaspora</h4>
                <p className="text-lg">View our latest collections.</p>
        ...
        <div className="container relative">
            ...
            <div className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 pt-6 gap-6">
                {collections.map((item,index)=>{
                    return(
                        <Link href="" className="text-center hover:text-blue-500" key={index}>
                ...
                {newProduct.slice(0,12).map((item, index)=>{
                    return(
                        <div className="group" key={index}>
                            ...
                            <div className="mt-4">
                                <Link href={`/product-detail-one/${item.id}`} className="hover:text-blue-500 text-lg font-medium">{item.name}</Link>
        ...
        <div className="container relative md:mt-24 mt-16">
            <div className="grid items-end md:grid-cols-2 mb-6">
                ...
                <div className="md:text-end hidden md:block">
                    <Link href="/shop-grid" className="text-slate-400 hover:text-blue-500">See More Items <i className="mdi mdi-arrow-right"></i></Link>
                </div>
            </div>
